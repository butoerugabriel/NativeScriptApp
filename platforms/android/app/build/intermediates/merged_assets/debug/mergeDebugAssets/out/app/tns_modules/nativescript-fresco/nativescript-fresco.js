...
function initializeControllerListener() {
    ...
    var ControllerListenerImpl = (function (_super) {
        __extends(ControllerListenerImpl, _super);
        function ControllerListenerImpl(owner) {
            var _this = _super.call(this) || this;
            _this.owner = owner;
            return global.__native(_this);
        }
        ControllerListenerImpl.prototype.onFinalImageSet = function (id, imageInfo, animatable) {
            if (this.owner) {
        ...
        ControllerListenerImpl.prototype.onFailure = function (id, throwable) {
            if (this.owner) {
        ...
        ControllerListenerImpl.prototype.onIntermediateImageFailed = function (id, throwable) {
            if (this.owner) {
                var frescoError = new FrescoError(throwable);
                var args = {
        ...
        ControllerListenerImpl.prototype.onIntermediateImageSet = function (id, imageInfo) {
            if (this.owner) {
                var info = new ImageInfo(imageInfo);
                var args = {
        ...
        ControllerListenerImpl.prototype.onRelease = function (id) {
            if (this.owner) {
                var args = {
        ...
        ControllerListenerImpl.prototype.onSubmit = function (id, callerContext) {
            if (this.owner) {
                var args = {
        ...
        ControllerListenerImpl = __decorate([
            Interfaces([com.facebook.drawee.controller.ControllerListener]),
            __metadata("design:paramtypes", [FrescoDrawee])
        ], ControllerListenerImpl);
        return ControllerListenerImpl;
    }(java.lang.Object));
...
var FrescoDrawee = (function (_super) {
    ...
    FrescoDrawee.prototype.initNativeView = function () {
        ...
        var listener = new ControllerListener(this);
    ...
    FrescoDrawee.prototype.initImage = function () {
        if (this._android) {
            ...
            if (this.imageUri) {
                ...
                var requestBuilder = com.facebook.imagepipeline.request.ImageRequestBuilder.newBuilderWithSource(uri)
                ...
                if (this.nativeViewProtected.listener) {
                    builder.setControllerListener(this.nativeViewProtected.listener);
                }
